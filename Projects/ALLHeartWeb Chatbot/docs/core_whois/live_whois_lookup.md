---
title: Live WHOIS Lookup
category: Core WHOIS
endpoint: GET https://api-v1.whoisdatacenter.com/api/v2/domain/whois/live
method: GET
source_url: https://whoisdatacenter.com/api-docs/#live-whois-lookup
---
