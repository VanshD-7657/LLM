---
title: WHOIS Creation Date
category: Domain Intelligence
endpoint: GET https://api-v1.whoisdatacenter.com/api/v2/domain/creation-date
method: GET
source_url: https://whoisdatacenter.com/api-docs/#whois-creation-date
---
