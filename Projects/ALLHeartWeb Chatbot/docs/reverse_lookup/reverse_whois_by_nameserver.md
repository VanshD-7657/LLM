---
title: Reverse WHOIS by Nameserver
category: Reverse WHOIS
endpoint: GET https://api-v1.whoisdatacenter.com/api/v2/nameserver
method: GET
source_url: https://whoisdatacenter.com/api-docs/#reverse-whois-by-nameserver
---
